...
import 'package:intl/intl.dart';
  ...
  class _FormTestState extends State<FormTest> {
    ...
    Future<void> _saveDataToDatabase() async {
      // You should implement the logic to save data to your database here.
      // Use the values from the controllers to save the data.
      print('Saving data to database...');
      print('Name: ${nameController.text}');
      print('National ID: ${idController.text}');
      ...
      // Add logic to save the image to the database if needed.
    }
